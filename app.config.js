...
const name = {
    development: "LVECDE (dev)",
    preview: "LVECDE (preview)",
    production: "LVECDE"
}[variant];
const bundleId = {
    development: "ai.remylovelogic.lvecde.dev",
    preview: "ai.remylovelogic.lvecde.preview",
    production: "ai.remylovelogic.lvecde"
}[variant];
